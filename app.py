...
def get_sql_chain(db):
    ...
    llm= ChatGroq(model="mixtral-8x-7b-32768",temperature=0.5, groq_api_key="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")
...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [
        AIMessage(content="Hello! Im a SQL assistant. Ask me anything about your database")
    ]
...
user_query= st.chat_input("Type messages")
